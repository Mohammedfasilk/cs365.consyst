...
const getNetProfitLoss = (billingData, directExpensesData, investorProfitSharePercent, miscellaneousIndirectExpense) =>
  getBillingTotal(billingData) - getTotalExpenses(billingData, directExpensesData, investorProfitSharePercent, miscellaneousIndirectExpense);
...
const getRows = (purchaseOrderData,
  ...
  const directExpensesRows = [
    ...
    createDataRow("Programming", directExpensesData.programming_outsourced,projectedDirectExpensesData.programming_outsourced),
    createDataRow("Engineering", directExpensesData.engineering,projectedDirectExpensesData.engineering),
    ...
    createDataRow("Warranty", directExpensesData.extended_warranty_cost, projectedDirectExpensesData.extended_warranty_cost),
