...
const getDirectExpenses = (project) => {
  return {
    ...
    engineering: project?.engineering || 0,
...
const getRows = (
  ...
  const directExpensesRows = [
    ...
    createDataRow("Programming", directExpensesData.programming_outsourced),
    createDataRow("Engineering", directExpensesData.engineering),
    createDataRow("Installation (Sub-Contract)", directExpensesData.installation_subcontract),
    createDataRow("Warranty", directExpensesData.extended_warranty_cost),
