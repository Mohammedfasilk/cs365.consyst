...
export default function Sidebar() {
      ...
      subItems: [
        {
          ...
          href: "/project-management/project-dashboard",
        },
  ...
  menuItems.forEach((item) => {
    ...
    switch (item.label) {
      ...
      case "Finance":
        if (
          userRole.includes("finance-user") ||
          userRole.includes("finance-manager")
        ) {
          allowedMenuItems.push(item);
        }
        break;
      ...
      case "Project Management":
        if (
          userRole.includes("project-user") ||
