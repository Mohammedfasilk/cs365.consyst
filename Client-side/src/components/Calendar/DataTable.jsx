...
import { setIsOpen, setSelectedCalendar, setSelectedCalendarId } from "../../Redux/Slices/calendarSheetSlice"
                    ...
                    <TableCell
                      ...
                      onClick={() => {
                        if (cell.column.id !== "actions") {
                          const calenderId = row.original._id
                          const calendar = row.original
                          if (calenderId) {
                            dispatch(setSelectedCalendarId(calenderId))
